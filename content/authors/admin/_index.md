...
skills:
  - name: Ανοιχτή αγγειακή χειρουργική
    items:
      - name: Αορτική χειρουργική (ανοιχτή αποκατάσταση ανευρύσμαος - αορτοδιμηριαία παράκαμψη για αποφρακτική νόσο)
        percent: 90
        icon: scalpel
      - name: Καρωτιδική Νόσος (ενδαρτηρεκτομη καρωτίδας)
        percent: 85
        icon: heart-pulse
      - name: Περιφερική αρτηριακή νόσος (μηροιγνυακές και περιφερικές παρακάμψεις)
        percent: 90
        icon: waveform
      - name: Αγγειακή προσπέλαση για αιμοκάθαρση (φίστουλες και μοσχεύματα αιμοκάθαρσης)
        percent: 80
        icon: plug
  - name: Ενδαγγειακή χειρουργική (ελάχιστα επεμβατικής)
    items:
      - name: Αορτική χειρουργική (EVAR - TEVAR αποκατάσταση κοιλιακών και θωρακικών ανευρυσμάτων με χρήση stents)
        percent: 90
        icon: scalpel
      - name: Καρωτιδική Νόσος (stent καρωτίδας)
        percent: 85
        icon: heart-pulse
      - name: Περιφερική αρτηριακή νόσος (αγγειοπλαστική και stenting )
        percent: 90
        icon: waveform
      - name: Αγγειακή προσπέλαση για αιμοκάθαρση (αγγειοπλαστική φίστουλας, τοποθέτηση κεντρικού καθετήρα αιμοκάθαρσης)
        percent: 80
        icon: plug
